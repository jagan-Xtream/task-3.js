...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
//Return MEDIAN of two sorted arrays of same size IN JAVASCRIPT
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
//Return all the PRIME numbers in an array  IN JAVASCRIPT
let n=9;
let x;
let y;
let prime=function (){
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
//Sum of all numbers in an array  IN JAVASCRIPT
...
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 //Convert all the strings to TITLE CAPS in a string array  IN JAVASCRIPT
